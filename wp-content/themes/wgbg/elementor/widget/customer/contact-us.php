 ...
 * @since 1.1.0
 */
class GCCCU extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact US', 'mage-eventpress' );
	}
	...
	protected function render() {
        ...
        $title_1                    = $settings['gccu_title_text_1'];    
        $title_2                    = $settings['gccu_title_text_2'];    
        $gcbc_details_text          = $settings['gccu_details_text']; 
        $gcbc_form                  = $settings['gccu_form'];   
        $main_image                 = $settings['gccu_main_image']['url'];        
		?>	
                  ...
                  <div class="banner-content-inner">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                          <div class="signup-form contact-us">
                            <div class="contact-left">
                              <img src="<?php echo $main_image; ?>" alt="">
                            </div>
                            <div action="#" class="contacts-form">
